...
{
    public partial class criaçãoBancoDados : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CartaoId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nome = table.Column<string>(maxLength: 20, nullable: false),
                    Bandeira = table.Column<string>(maxLength: 20, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "62246b43-0d12-4107-9c12-06a4984c7900", "e4efe140-15ac-42ae-9fd2-ef666396a14a", "ADMINISTRADOR DO SISTEMA", "Administrador", "ADMINISTRADOR" },
                    { "5f19b597-a232-4cb2-bdab-a154f8a24be6", "c8719cf8-f931-4f30-a1d0-787f719f6ab4", "Usuário do Sistema", "Usuario", "USUARIO" }
                });
